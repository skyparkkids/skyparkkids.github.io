          ...
          <div className="col">
            ...
            <h4>
              ...
              <div className="mt-2">
                ...
                <br />
                <span className="badge badge-danger mb-2">
                  {CONTACT.name} Grip Socks for each kid
                </span>
              </div>
            </h4>
          </div>
          ...
          <div className="col">
            ...
            <ul className="list-group">
              ...
              <li className="list-group-item list-group-item-success">
                Full service clean up & set up
              </li>
              <li className="list-group-item list-group-item-danger">
                Table cover, plates, cups, napkins and forks
              </li>
              <li className="list-group-item list-group-item-warning">
                1 Free SKYPARKKIDS T-Shirts for the birthday child
              </li>
              <li className="list-group-item list-group-item-info">
                1 hour Free jump pass for the birthday child
              </li>
              <li className="list-group-item list-group-item-light">
                to use on any future visit
              </li>
            </ul>
            <div className="text-left mt-4">
              <p className="lead text-secondary">
                * Note: Birthday Party reservation must be made in person at the
                store. Online or phone reservations are not accepted at the
                moment.{" "}
                <a className="text-danger" href={pdfFile} target="_blank">
                  Party Package Reservation Form
                </a>
              </p>
              {/* <p className="lead mt-4 font-weight-bold text-primary">
                There will be Special Sales for Birthday Party reservation
